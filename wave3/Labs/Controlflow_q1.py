...
nom_count_dict = {}
# Add your code here
mega_nomination_list = []
for key, value in nominated.items():
    mega_nomination_list.extend(value)

nom_count_dict = {k:mega_nomination_list.count(k) for k in (mega_nomination_list)}
...
win_count_dict = {k:mega_win_list.count(k) for k in (mega_win_list)}
